...
#+:ignore ; this is the original definition
(defsystem :wilbur
  :name "wilbur"
  ...
  :components ((:file "packages-1")
		...
		:depends-on ("packages" "platform" "useful"))
	       (:module :core
	        :components ((:file "hash-table-2")
			     (:file "data" :depends-on ("hash-table-2"))
...
(defsystem :wilbur
  ...
  :components ((:file "packages-1")
	       ...
	       (:file "platform" :depends-on ("packages-1"))
               #+:ignore
	       (:file "useful" :depends-on ("packages-1"))
	       (:module 
		:nox
		:components ((:file "core-constants-2")
			     (:file "xml-util-2" :depends-on ("core-constants-2"))
			     (:file "xml-parser-2" :depends-on ("xml-util-2")))
		:depends-on ("packages-1" #+:ignore "platform" #+:ignore "useful"))
               #+:ignore
	       (:module 
		:core
